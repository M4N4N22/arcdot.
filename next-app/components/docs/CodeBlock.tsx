...
export function CodeBlock({
  ...
  return (
    <div className="my-5 overflow-hidden border border-line bg-[#141414]">
      ...
      <pre className="overflow-x-auto p-4 font-mono text-[11px] leading-relaxed text-zinc-300 whitespace-pre">
        {code}
      </pre>
    </div>
  );
